describe("simple-ai-assist.config", function()
  ...
  describe("setup", function()
    ...
    it("should notify error if no API key found", function()
      ...
      local expected_msg = "No API key found. Please set OPENROUTER_API_KEY, OPENAI_API_KEY, or ANTHROPIC_API_KEY"
      assert.spy(notify_spy).was_called_with(expected_msg, vim.log.levels.ERROR)
    end)
  end)
end)
