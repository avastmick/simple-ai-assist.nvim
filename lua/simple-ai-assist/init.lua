...
function M.trigger_assistant()
  ...
  vim.schedule(function()
    ui.show_assistant(selected_text, {
      start_line = start_line - 1, -- 0-based for API calls
      end_line = end_line, -- end_line is exclusive in nvim_buf_set_lines
      buffer = current_buf,
      display_start_line = start_line, -- 1-based for display
    })
  end)
end
